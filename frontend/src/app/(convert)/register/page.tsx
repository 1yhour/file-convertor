      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden border border-zinc-100">
        <div className="p-8 sm:p-12">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-zinc-500">Join us and start your journey today.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-xs font-medium text-zinc-700 uppercase tracking-wider mb-2">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-medium text-zinc-700 uppercase tracking-wider mb-2">
                Password
              </label>
            ...
            <div>
              <label htmlFor="password_confirmation" className="block text-xs font-medium text-zinc-700 uppercase tracking-wider mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <input
